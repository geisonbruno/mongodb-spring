package com.geisonbrunodev.mongodbspring.config;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vou viajar para Redentora. Abraços!",new AuthorDTO(maria));
        Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Bom trabalho!", new AuthorDTO(maria));

        CommentDTO c1 = new CommentDTO("Boa viagem irmão!", sdf.parse("21/03/2024"), new AuthorDTO(alex));
